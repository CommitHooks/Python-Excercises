...
for quizNum in range(35):
    ...
    """
    The placeholder %s will be replaced by (quizNum +  1)
    """
...
for questionNum in range(50):
    ...
    wrongAnswers = list(capitals.values()) # Get the list of all values in capitals
    del wrongAnswers[wrongAnswers.index(correctAnswer)] # Deleting the correct answer
    wrongAnswers = random.sample(wrongAnswers, 3)
    answerOptions = wrongAnswers + [correctAnswer] # Make it a question with 4 options
